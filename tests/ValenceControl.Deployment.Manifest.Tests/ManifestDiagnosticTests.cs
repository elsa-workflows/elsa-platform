...
public class ManifestDiagnosticTests
{
    ...
    {
        var manifest = _reader.Read(ManifestReaderTests.SampleYaml.Replace(DeploymentManifestConstants.ApiVersion, "valence-control/v2"), ManifestFormat.Yaml).Manifest!;
    ...
    [InlineData(ManifestFormat.Json, """{ "apiVersion": "valence-control/v1alpha1", "kind": """)]
