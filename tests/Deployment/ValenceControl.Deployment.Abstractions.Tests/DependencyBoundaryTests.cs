...
public class DependencyBoundaryTests
{
    ...
    public void DeploymentAbstractionsProjectHasNoForbiddenReferences()
    {
        var projectFile = _repoRoot
            ...
            .Single(file => file.FullName.Contains(
                Path.Combine("src", "Deployment", "ValenceControl.Deployment.Abstractions"),
    ...
    {
        var sourceRoot = new DirectoryInfo(Path.Combine(_repoRoot.FullName, "src", "Deployment", "ValenceControl.Deployment.Abstractions"));
