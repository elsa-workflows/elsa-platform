...
public class ArtifactBoundaryTests
{
    ...
    public void ArtifactProjectReferencesOnlyAllowedProjects()
    {
        var projectFile = _repoRoot
            ...
            .Single(file => file.FullName.Contains(Path.Combine("src", "Deployment", "ValenceControl.Deployment.Artifacts"), StringComparison.Ordinal));
    ...
    public void ArtifactTestProjectReferencesOnlyFocusedTestDependencies()
    {
        var projectFile = _repoRoot
            ...
            .Single(file => file.FullName.Contains(Path.Combine("tests", "Deployment", "ValenceControl.Deployment.Artifacts.Tests"), StringComparison.Ordinal));
        var references = ReferencesFrom(projectFile);
    ...
    {
        var sourceRoot = new DirectoryInfo(Path.Combine(_repoRoot.FullName, "src", "Deployment", "ValenceControl.Deployment.Artifacts"));
