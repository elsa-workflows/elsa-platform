...
public class ManifestBoundaryTests
{
    ...
    public void ManifestProjectReferencesOnlyAllowedProjects()
    {
        var projectFile = _repoRoot
            ...
            .Single(file => file.FullName.Contains(Path.Combine("src", "Deployment", "ValenceControl.Deployment.Manifest"), StringComparison.Ordinal));
    ...
    public void ManifestTestProjectReferencesOnlyFocusedTestDependencies()
    {
        var projectFile = _repoRoot
            ...
            .Single(file => file.FullName.Contains(Path.Combine("tests", "Deployment", "ValenceControl.Deployment.Manifest.Tests"), StringComparison.Ordinal));
    ...
    {
        var sourceRoot = new DirectoryInfo(Path.Combine(_repoRoot.FullName, "src", "Deployment", "ValenceControl.Deployment.Manifest"));
