...
public sealed class AdminPackagesApiTests
{
    ...
    public async Task Admin_can_review_visible_and_unapproved_packages()
    {
        ...
        var packages = await client.GetPlatformJsonAsync<List<AdminPackageListResponse>>("/api/admin/packages");
    ...
    public async Task Package_details_return_summary_source_canonical_casing_and_latest_version_data()
    {
        ...
        var package = await client.GetPlatformJsonAsync<AdminPackageResponse>("/api/admin/packages/elsa.persistence.postgresql");
    ...
    public async Task Package_details_return_empty_versions_for_packages_without_indexed_versions()
    {
        ...
        var package = await client.GetPlatformJsonAsync<AdminPackageResponse>("/api/admin/packages/Elsa.Empty");
    ...
    public async Task Package_details_include_feature_settings_dependencies_and_manifest_metadata()
    {
        ...
        var package = await client.GetPlatformJsonAsync<AdminPackageResponse>("/api/admin/packages/Elsa.Email");
    ...
    public async Task Package_version_manifest_endpoint_returns_raw_manifest_metadata()
    {
        ...
        var manifest = await client.GetPlatformJsonAsync<AdminVersionManifestResponse>("/api/admin/packages/Elsa.Email/versions/1.0.0/manifest");
