...
public sealed class PublicBuilderBundleApiTests
{
    ...
    public async Task Trusted_builder_client_can_generate_bundle()
    {
        ...
        var response = await BuilderClient(app).PostPlatformJsonAsync("/api/builder/bundle", MinimalRequest());
    ...
    public async Task Direct_untrusted_bundle_calls_are_rejected()
    {
        ...
        var response = await app.CreateClient().PostPlatformJsonAsync("/api/builder/bundle", MinimalRequest());
    ...
    public async Task Builder_credentials_do_not_authorize_admin_apis()
    {
        ...
        var bundle = await client.PostPlatformJsonAsync("/api/builder/bundle", MinimalRequest());
    ...
    public async Task Admin_credentials_do_not_authorize_builder_bundle_generation()
    {
        ...
        var response = await client.PostPlatformJsonAsync("/api/builder/bundle", MinimalRequest());
    ...
    public async Task Blocked_domain_response_returns_empty_files()
    {
        ...
        var response = await BuilderClient(app).PostPlatformJsonAsync("/api/builder/bundle", MinimalRequest(imageSlug: "missing"));
    ...
    private static HttpClient BuilderClient(PlatformApiTestApplication app)
    {
        var client = app.CreateClient();
