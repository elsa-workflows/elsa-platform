...
{
    public static HttpClient CreatePlatformIdentityClient(
        this PlatformApiTestApplication app,
        string subject = "user-123",
        string? issuer = PlatformApiTestApplication.TestPlatformIdentityIssuer,
        string? audience = PlatformApiTestApplication.TestPlatformIdentityAudience,
        ...
        IReadOnlyDictionary<string, string>? claims = null)
    {
        ...
        var descriptor = new SecurityTokenDescriptor
        {
            ...
            SigningCredentials = new SigningCredentials(
                new SymmetricSecurityKey(Encoding.UTF8.GetBytes(PlatformApiTestApplication.TestPlatformIdentitySigningKey)),
