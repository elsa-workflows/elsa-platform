...
public sealed class PlatformHealingVerifiedWebhookHandlerTests
{
        ...
        HealingDbContext context) : IAsyncDisposable
    {
        ...
        public PlatformHealingVerifiedWebhookHandler CreateHandler(
            IHealingProviderCredentialResolver resolver,
            IPlatformHealingGitHubWebhookProcessorRunner? processorRunner = null)
        {
            var timeProvider = new FixedTimeProvider(Now);
            var replayStore = new PlatformGitHubReplayStore(Context, timeProvider);
            return new PlatformHealingVerifiedWebhookHandler(
                Context,
                resolver,
    ...
    private sealed class TestScopedWebhookProcessorRunner(
        ...
        Guid? failingWorkspaceId) : IPlatformHealingGitHubWebhookProcessorRunner
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return await new PlatformHealingGitHubWebhookProcessor(
                    context,
