...
public sealed class ManagedRepairProposalBindingTests
{
    ...
    public void Exact_proposal_allows_repository_validation_fields_only()
    {
        ...
        PlatformHealingWorkloadApi.MatchesProposal(result, proposal).Should().BeTrue();
    }
    ...
    public void Repository_result_cannot_replace_managed_inference_fields(string mutation)
    {
        ...
        PlatformHealingWorkloadApi.MatchesProposal(result, proposal).Should().BeFalse();
    }

    private static PlatformHealingWorkloadApi.StoredManagedProposal Proposal()
    {
    ...
    private static RepairResultEnvelope Result(PlatformHealingWorkloadApi.StoredManagedProposal proposal)
    {
