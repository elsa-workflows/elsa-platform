...
public sealed class AdminApprovalApiTests
{
    ...
    public async Task Admin_can_approve_package_and_version()
    {
        ...
        var packageDetails = await client.GetPlatformJsonAsync<AdminPackageResponse>("/api/admin/packages/Elsa.Email");
        ...
        var versionResponse = await client.PostPlatformJsonAsync("/api/admin/packages/Elsa.Email/versions/1.0.0/approve", new ApprovalRequest(null, token));
    ...
    public async Task Version_rejection_requires_reason()
    {
        ...
        var response = await client.PostPlatformJsonAsync("/api/admin/packages/Elsa.Email/versions/1.0.0/reject", new ApprovalRequest(" ", null));
    ...
    public async Task Version_approval_rejects_stale_state_tokens()
    {
        ...
        var response = await client.PostPlatformJsonAsync("/api/admin/packages/Elsa.Email/versions/1.0.0/approve", new ApprovalRequest("Reviewed", "stale"));
