...
{
    private const string TestSqlServerConnectionString = @"Server=(localdb)\MSSQLLocalDB;Initial Catalog=ValenceControlCatalogProviderTests;Integrated Security=True;Encrypt=False";
