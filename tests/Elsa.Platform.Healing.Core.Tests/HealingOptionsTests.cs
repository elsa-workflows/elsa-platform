...
public sealed class HealingOptionsTests
{
    ...
    [Fact]
    public void PlatformKillSwitchBlocksRepairEvenWhenApplicationAndStageAreEnabled()
    {
        ...
        result.Should().Be(new HealingGateResult(false, HealingGateReasonCodes.PlatformKillSwitch));
    }
