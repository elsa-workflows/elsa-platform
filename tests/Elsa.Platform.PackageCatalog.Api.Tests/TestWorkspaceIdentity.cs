...
internal static class TestWorkspaceIdentity
{
    public static HttpClient CreatePlatformIdentityClient(
        this CatalogApiTestApplication app,
        string subject = "user-123",
        string? issuer = CatalogApiTestApplication.TestPlatformIdentityIssuer,
        string? audience = CatalogApiTestApplication.TestPlatformIdentityAudience,
        ...
        IReadOnlyDictionary<string, string>? claims = null)
    {
        ...
        var descriptor = new SecurityTokenDescriptor
        {
            ...
            SigningCredentials = new SigningCredentials(
                new SymmetricSecurityKey(Encoding.UTF8.GetBytes(CatalogApiTestApplication.TestPlatformIdentitySigningKey)),
