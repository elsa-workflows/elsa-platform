...
public sealed class AdminDashboardAuthenticationTests
{
    ...
    private static void AddPlatformSessionCookie(CatalogApiTestApplication app, HttpClient client, params Claim[] additionalClaims)
    {
        ...
        {
            new("sub", "admin-user"),
            new("iss", CatalogApiTestApplication.TestPlatformIdentityIssuer),
            new("name", "Admin User")
        };
