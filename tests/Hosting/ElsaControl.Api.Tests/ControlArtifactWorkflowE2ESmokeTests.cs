...
public sealed class ControlArtifactWorkflowE2ESmokeTests
{
        ...
        InMemoryWorkflowArtifactApplyJournal applyJournal)
    {
        ...
        var processor = new WorkflowArtifactCommandProcessor(
            commandClient,
            new WorkflowArtifactControlEnvelopeClient(owner, options),
            payloads,
    ...
    private static async Task<DeploymentTopology> SeedTopologyAsync(ControlApiTestApplication app, Guid workspaceId)
    {
