@description('Managed workload Key Vault name. The name must be globally unique and 3-24 characters.')
@minLength(3)
@maxLength(24)
param name string
...
@description('Name of the runtime administrator credential created by the host after the vault exists.')
@minLength(1)
@maxLength(127)
...
// The runtime can read only secret values. It cannot administer the workload vault.
