...
-- administrator, after the workload database exists. The host substitutes the
-- __...__ placeholders from validated arguments; this file contains no secret.
--
-- The workload identity is granted DDL for first-start/upgrade migrations.
-- Revoke db_ddladmin after migrations if the deployment policy requires a
-- reduced runtime principal.
