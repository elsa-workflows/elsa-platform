...
- [X] T002 [P] Create planner API test file `tests/Elsa.Platform.Api.Tests/BuilderPlanApiTests.cs`
...
- [X] T005 Register planner service in `src/Elsa.Platform.Api/Program.cs`
...
- [X] T008 [US1] Add `POST /api/builder/plan` DTOs in `src/Elsa.Platform.Api/Public/Builder/BuilderContracts.cs`
- [X] T009 [US1] Add `POST /api/builder/plan` endpoint in `src/Elsa.Platform.Api/Public/Builder/BuilderEndpoints.cs`
...
- [X] T011 [US2] Integrate planner into compatibility resolve flow in `src/Elsa.Platform.Api/Public/Builder/BuilderEndpoints.cs`
...
- [X] T013 [US3] Add API tests for resolved state and auto-added response shape in `tests/Elsa.Platform.Api.Tests/BuilderPlanApiTests.cs`
- [X] T014 [US3] Add workspace planner endpoint in `src/Elsa.Platform.Api/Workspace/WorkspaceBuilderEndpoints.cs`
- [X] T015 [US3] Document frontend migration notes in `specs/012-server-side-planning/quickstart.md`

## Phase 6: Polish

- [X] T016 Add planner examples in `src/Elsa.Platform.Api/Elsa.Platform.Api.http`
