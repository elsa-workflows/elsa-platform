...
2. Create a store named `Elsa Control engine credentials` with type `Local encrypted database`.
...
4. Verify generic external reference help text says Elsa Control cannot browse or verify it.
