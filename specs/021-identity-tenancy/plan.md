...
Extend `Authentication:PlatformIdentity` from JWT validation into a complete customer identity configuration surface:
...
1. Keep the existing `PlatformOidcJwt` JWT bearer validation for API clients and token-accepting deployments.
