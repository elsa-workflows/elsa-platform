...
**Scope**: Elsa Control implementation plus the merged Elsa Foundation OpenTelemetry ingestion seam
...
- The repair agent never receives a GitHub write credential; Elsa Control's trusted publisher performs mutations.
