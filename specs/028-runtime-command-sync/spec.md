...
- Elsa Control API restarts while commands are pending, claimed, or completing.
...
- **Webhook Notification**: Non-authoritative command-available trigger that tells a runtime to fetch commands from Elsa Control.
