...
- [ ] T001 [P] Create managed hosting API tests in `tests/Elsa.Platform.Api.Tests/ManagedHostingApiTests.cs`
...
- [ ] T006 Register managed hosting services in `src/Elsa.Platform.Api/Program.cs`

## Phase 3: User Story 1 - Provision Managed Runtime (Priority: P1)

- [ ] T007 [US1] Add provision API tests in `tests/Elsa.Platform.Api.Tests/ManagedHostingApiTests.cs`
- [ ] T008 [US1] Implement provision service in `src/Elsa.Platform.PackageCatalog.Core/ManagedHosting/ManagedHostingService.cs`
- [ ] T009 [US1] Add provision endpoint in `src/Elsa.Platform.Api/Workspace/WorkspaceManagedHostingEndpoints.cs`

## Phase 4: User Story 2 - Runtime Lifecycle (Priority: P1)

- [ ] T010 [US2] Add lifecycle action tests in `tests/Elsa.Platform.Api.Tests/ManagedHostingApiTests.cs`
...
- [ ] T012 [US2] Add lifecycle endpoints in `src/Elsa.Platform.Api/Workspace/WorkspaceManagedHostingEndpoints.cs`

## Phase 5: User Story 3 - Runtime Endpoint And Health (Priority: P2)

- [ ] T013 [US3] Add health/status tests in `tests/Elsa.Platform.Api.Tests/ManagedHostingApiTests.cs`
