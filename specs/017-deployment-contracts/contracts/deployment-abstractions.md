...
`Elsa.Platform.Deployment.Abstractions` defines the deployment language shared by manifest, artifact, engine, CLI, API, operator, and extension packages. It does not implement parsing, IO, reconciliation, persistence, transport, or runtime adapters.
