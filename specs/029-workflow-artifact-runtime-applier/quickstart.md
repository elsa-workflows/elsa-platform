...
- 2026-05-29: `dotnet test tests/Elsa.Platform.Workflows.RuntimeApplier.Tests/Elsa.Platform.Workflows.RuntimeApplier.Tests.csproj --no-restore -v minimal` passed: 50 tests. This adds HTTP(S) workflow artifact payload loading with expired-reference, URI/scheme, media-type, size-limit, remote failure, and safe error handling coverage.
