...
- 2026-05-29: `dotnet test tests/Elsa.Platform.Workflows.RuntimeApplier.Tests/Elsa.Platform.Workflows.RuntimeApplier.Tests.csproj --no-restore -v minimal` passed: 89 tests. This completes runtime digest and schema compatibility validation, including case-insensitive SHA-256 digest comparison, payload reference digest consistency, runtime version range compatibility, unsupported schema rejection, missing capability rejection, invalid JSON payload rejection, and safe diagnostics.
