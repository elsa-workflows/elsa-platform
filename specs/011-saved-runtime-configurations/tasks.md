...
- [X] T001 [P] Create API test file `tests/Elsa.Platform.Api.Tests/WorkspaceRuntimeConfigurationApiTests.cs`
...
- [X] T008 Register runtime configuration services and store in `src/Elsa.Platform.Api/Program.cs`

## Phase 3: User Story 1 - Save And Reopen (Priority: P1)

- [X] T009 [US1] Add API tests for create/list/get workspace configuration in `tests/Elsa.Platform.Api.Tests/WorkspaceRuntimeConfigurationApiTests.cs`
...
- [X] T012 [US1] Add workspace API endpoints in `src/Elsa.Platform.Api/Workspace/WorkspaceRuntimeConfigurationEndpoints.cs`

## Phase 4: User Story 2 - Clone And Edit (Priority: P1)

- [X] T013 [US2] Add API tests for update, delete, and clone in `tests/Elsa.Platform.Api.Tests/WorkspaceRuntimeConfigurationApiTests.cs`
...
- [X] T016 [US2] Add update/delete/clone endpoints in `src/Elsa.Platform.Api/Workspace/WorkspaceRuntimeConfigurationEndpoints.cs`
- [X] T017 [US2] Add bundle-from-configuration endpoint in `src/Elsa.Platform.Api/Workspace/WorkspaceRuntimeConfigurationEndpoints.cs`

## Phase 5: User Story 3 - Explicit Versions (Priority: P2)

- [X] T018 [US3] Add version snapshot tests in `tests/Elsa.Platform.Api.Tests/WorkspaceRuntimeConfigurationApiTests.cs`
...
- [X] T021 [US3] Add version endpoints in `src/Elsa.Platform.Api/Workspace/WorkspaceRuntimeConfigurationEndpoints.cs`

## Phase 6: Polish

- [X] T022 Update API examples in `src/Elsa.Platform.Api/Elsa.Platform.Api.http`
