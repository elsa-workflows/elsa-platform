...
**Input**: User description: "Move deployment-affecting Docker runtime image metadata out of the Lovable static frontend file and into the Elsa Platform backend so image selection, environment defaults, companion rules, and bundle generation use a single source of truth."

## User Scenarios & Testing *(mandatory)*

### User Story 1 - Select Runtime Images From Platform Metadata (Priority: P1)
