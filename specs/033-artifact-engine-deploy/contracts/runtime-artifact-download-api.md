...
- Platform preserves the successful and failed item outcomes.
- Platform does not report automatic rollback unless a separate runtime recovery action explicitly performed and reported it.
