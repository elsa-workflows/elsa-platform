# Tasks: Studio Submit To Elsa Control

**Input**: Design documents from `specs/027-studio-submit-to-elsa-control/`
...
## Phase 2: Elsa Control Submission API Compatibility
...
- [x] T006 Add any missing Elsa Control contract fields required by Studio submission without storing raw workflow content in catalog tables.

## Phase 3: Studio Integration Package

- [x] T007 Create the Studio integration package skeleton.
- [x] T008 Add configuration options for Elsa Control endpoint, workspace, authentication, and publish separation policy.
- [x] T009 Add **Submit to Elsa Control** command and result state model.
- [x] T010 Package workflow snapshot, safe metadata, source identifiers, schema version, digest, and payload reference.
- [x] T011 Submit artifact envelope to Elsa Control and handle idempotent duplicate results.
