...
dotnet test tests/ElsaControl.Weaver.Core.Tests/ElsaControl.Weaver.Core.Tests.csproj --no-restore
npm run typecheck --prefix src/ElsaControl.Console
npm test --prefix src/ElsaControl.Console -- Weaver
git diff --check
```
