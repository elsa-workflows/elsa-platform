...
- [ ] T001 [P] Create BYOC API tests in `tests/Elsa.Platform.PackageCatalog.Api.Tests/WorkspaceDeploymentTargetApiTests.cs`
...
- [ ] T007 Register services in `src/Elsa.Platform.PackageCatalog.Api/Program.cs`

## Phase 3: User Story 1 - Register Target (Priority: P1)

- [ ] T008 [US1] Add registration and validation API tests in `tests/Elsa.Platform.PackageCatalog.Api.Tests/WorkspaceDeploymentTargetApiTests.cs`
...
- [ ] T010 [US1] Add target endpoints in `src/Elsa.Platform.PackageCatalog.Api/Workspace/WorkspaceDeploymentTargetEndpoints.cs`
...
- [ ] T013 [US2] Add preview endpoint in `src/Elsa.Platform.PackageCatalog.Api/Workspace/WorkspaceDeploymentTargetEndpoints.cs`

## Phase 5: User Story 3 - Deploy And Track Status (Priority: P2)

- [ ] T014 [US3] Add deployment run status tests in `tests/Elsa.Platform.PackageCatalog.Api.Tests/WorkspaceDeploymentTargetApiTests.cs`
...
- [ ] T016 [US3] Add deployment run endpoints in `src/Elsa.Platform.PackageCatalog.Api/Workspace/WorkspaceDeploymentTargetEndpoints.cs`
