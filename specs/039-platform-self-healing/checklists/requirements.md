# Specification Quality Checklist: Platform Self-Healing
...
- The named .NET, OpenTelemetry, and GitHub constraints are intentional v1 product boundaries, not prescriptions for Platform's internal implementation.
