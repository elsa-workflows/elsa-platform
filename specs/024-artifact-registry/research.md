...
**Rationale**: `Elsa.Platform.Deployment.Artifacts` already defines layout version, artifact identity, content digest, manifest metadata, resource summaries, entries, checksums, and diagnostics. The registry should project these concepts rather than invent a parallel artifact language.
