...
- 2026-05-28: `dotnet test tests/ElsaControl.Deployment.Core.Tests/ElsaControl.Deployment.Core.Tests.csproj --filter WorkspaceArtifact` passed: 9 tests.
- 2026-05-28: `dotnet test tests/ElsaControl.PackageCatalog.Persistence.EntityFrameworkCore.Tests/ElsaControl.PackageCatalog.Persistence.EntityFrameworkCore.Tests.csproj --filter DeploymentWorkspaceArtifact` passed: 6 tests.
- 2026-05-28: `dotnet test tests/ElsaControl.Api.Tests/ElsaControl.Api.Tests.csproj --filter WorkspaceArtifact` passed: 6 tests.
- 2026-05-28: `cd src/ElsaControl.Console && npm test -- --run artifacts` passed: 3 tests.
