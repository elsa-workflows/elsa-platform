...
- [ ] T001 [P] Create runtime operations API tests in `tests/Elsa.Platform.Api.Tests/RuntimeOperationsApiTests.cs`
...
- [ ] T006 [US1] Add health/log API tests in `tests/Elsa.Platform.Api.Tests/RuntimeOperationsApiTests.cs`
...
- [ ] T008 [US1] Add health/log endpoints in `src/Elsa.Platform.Api/Workspace/WorkspaceRuntimeOperationsEndpoints.cs`
...
- [ ] T011 [US2] Add backup/restore endpoints in `src/Elsa.Platform.Api/Workspace/WorkspaceRuntimeOperationsEndpoints.cs`
...
- [ ] T014 [US3] Add upgrade endpoints in `src/Elsa.Platform.Api/Workspace/WorkspaceRuntimeOperationsEndpoints.cs`
