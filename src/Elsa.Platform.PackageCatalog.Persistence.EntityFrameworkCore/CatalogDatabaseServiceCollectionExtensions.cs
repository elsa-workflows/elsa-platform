...
public static class CatalogDatabaseServiceCollectionExtensions
{
    ...
    public const string SqliteMigrationsAssembly = "Elsa.Platform.PackageCatalog.Persistence.SqliteMigrations";
    public const string SqlServerMigrationsAssembly = "Elsa.Platform.PackageCatalog.Persistence.SqlServerMigrations";
