    ...
    IOptions<HealingVerificationFailureDeliveryOptions> options) : IRepairVerificationFailureConsumer
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        request.Headers.Add("X-Elsa-Platform-Event", "repair-verification-failed");
        request.Headers.Add("X-Elsa-Platform-Timestamp", timestamp);
        request.Headers.Add("X-Elsa-Platform-Signature", $"sha256={signature}");
