...
using ContractManifest = Elsa.Platform.Healing.ComponentManifest.HealingComponentManifest;
using ContractManifestSerializer = Elsa.Platform.Healing.ComponentManifest.ComponentManifestSerializer;
using ContractManifestValidationException = Elsa.Platform.Healing.ComponentManifest.ComponentManifestValidationException;
using CoreManifest = Elsa.Platform.Healing.Core.ComponentManifest;
...
public sealed class WorkspaceHealingConfigurationEndpointModule : IHealingEndpointModule
{
    ...
    private static CoreManifest ToCoreManifest(Guid workspaceId, Guid applicationId, Guid revisionId, ContractManifest contract, string canonicalJson)
    {
        ...
        var entries = contract.Components.Select(component =>
        {
            ...
            return new Elsa.Platform.Healing.Core.ComponentManifestEntry
            {
                Id = entryId,
...
{
    internal const string EffectivePermissionsItemKey = "Elsa.Platform.Healing.EffectiveWorkspacePermissions";
