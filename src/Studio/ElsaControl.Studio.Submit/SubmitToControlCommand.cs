...
public sealed class SubmitToControlCommand(
    IStudioWorkflowSnapshotPackager packager,
    IStudioControlSubmitClient submitClient,
    StudioSubmitOptions options)
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            var result = submitClient is IStudioControlRevisionSubmitClient revisionSubmitClient
