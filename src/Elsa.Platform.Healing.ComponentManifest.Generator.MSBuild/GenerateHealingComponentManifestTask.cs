...
namespace Elsa.Platform.Healing.ComponentManifest.Generator.MSBuild;
    ...
    public override bool Execute()
    {
        try
        {
            if (RequireSourceRevision && string.IsNullOrWhiteSpace(SourceRevision))
                throw new InvalidOperationException("A source revision is required. Set ElsaHealingSourceRevision or disable ElsaHealingRequireSourceRevision explicitly.");
