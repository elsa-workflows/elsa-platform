...
/// <summary>
/// Builds bounded evidence fields exclusively from Control-owned, post-redaction incident projections.
/// </summary>
public sealed class HealingEvidenceSource(HealingDbContext dbContext) : IHealingEvidenceSource
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var provenance = request.Fields.ToDictionary(x => x, _ => "control-incident-projection");
