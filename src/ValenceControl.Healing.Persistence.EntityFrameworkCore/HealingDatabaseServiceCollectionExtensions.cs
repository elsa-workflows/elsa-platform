...
{
    public const string DefaultSqliteConnectionString = "Data Source=valence-control-healing.db";
    public const string MigrationsHistoryTable = "__EFMigrationsHistory_Healing";
    public const string SqliteMigrationsAssembly = "ValenceControl.Healing.Persistence.SqliteMigrations";
    public const string SqlServerMigrationsAssembly = "ValenceControl.Healing.Persistence.SqlServerMigrations";
