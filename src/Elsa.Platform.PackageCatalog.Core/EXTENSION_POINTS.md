...
- **Layer:** Core — `Elsa.Platform.PackageCatalog.Core`
...
- **Known implementations:** `WorkspacePermissionOwnerProvisioner` *(cross-domain — Elsa.Platform.Api)* provisions the contributed workspace permission defaults.
