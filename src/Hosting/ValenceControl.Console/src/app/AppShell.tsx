...
const themeAccentStorageKey = "valence-control-console-theme-accent";
      ...
      <aside className="fixed inset-y-0 left-0 hidden w-72 flex-col border-r border-border bg-surface px-3 py-4 md:flex">
        <div>
          <div className="flex items-start justify-between gap-3 px-2 pb-6">
            <div>
              <p className="font-display text-base font-semibold tracking-normal">Valence Control</p>
      ...
      <div className="md:pl-72">
        <header className="sticky top-0 z-10 border-b border-border bg-background/95 px-4 py-3 backdrop-blur md:hidden">
          <div className="mb-2 flex items-center justify-between gap-3">
            <p className="font-display text-sm font-semibold">Valence Control</p>
...
function getStoredTheme(): Theme {
  ...
  try {
    return window.localStorage.getItem("valence-control-console-theme") === "dark" ? "dark" : "light";
  } catch {
    return "light";
  }
}
...
function storeTheme(theme: Theme) {
  ...
  try {
    window.localStorage.setItem("valence-control-console-theme", theme);
  } catch {
