...
const controlSignals: Signal[] = [
  {
    ...
    value: "4 configs",
    description: "Saved runtime configurations are planned as a Valence Control module.",
    icon: Boxes,
    status: "Roadmap"
  },
  {
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div className="max-w-3xl space-y-3">
          ...
          <p className="text-sm leading-6 text-muted-foreground md:text-base">
            One Valence Control console for package governance, runtime building, deployment artifacts, environment workbenches, and managed
            runtime operations.
          </p>
        </div>
      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_360px]">
        ...
        <section className="rounded-ui border border-border bg-surface">
          <div className="border-b border-border px-4 py-3">
            ...
            <p className="mt-1 text-sm text-muted-foreground">Static until Valence Control activity APIs are introduced.</p>
          </div>
