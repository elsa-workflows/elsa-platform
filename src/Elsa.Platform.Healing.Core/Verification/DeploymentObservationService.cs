    ...
    TimeProvider timeProvider) : IDeploymentObservationSink
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            DeploymentObservationSources.PlatformDeployment => DeploymentObservationSource.PlatformDeployment,
        ...
        await auditService.AppendAsync(new HealingAuditWrite(
            ...
            append.Value.Id,
            "deployment-observed",
            source == DeploymentObservationSource.PlatformDeployment ? "platform-deployment" : "external-delivery",
