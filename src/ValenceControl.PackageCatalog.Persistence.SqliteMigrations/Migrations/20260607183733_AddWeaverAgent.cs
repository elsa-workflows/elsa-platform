        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CopilotSessionId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    RoutePath = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    ContextJson = table.Column<string>(type: "TEXT", nullable: true),
                    Mode = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    ProviderMode = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    Model = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    ReasoningEffort = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RedactionState = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RollbackJson = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArgumentsHash = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    ResultSummaryJson = table.Column<string>(type: "TEXT", nullable: true),
                    AuthorizationResult = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    Status = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermissionSnapshotJson = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlanVersion = table.Column<int>(type: "INTEGER", nullable: false),
                    Status = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    LinkedResourceJson = table.Column<string>(type: "TEXT", nullable: false),
