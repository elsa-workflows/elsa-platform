...
/// <summary>
/// Workspace-scoped facade over the Control OpenTelemetry capability. Implementations must resolve telemetry
...
public sealed class HealingIntakeEndpointModule : IHealingEndpointModule
{
    ...
    private static IResult TelemetryUnavailable(HttpContext context) => Problem(
        ...
        "The Control OpenTelemetry capability is not configured.");
