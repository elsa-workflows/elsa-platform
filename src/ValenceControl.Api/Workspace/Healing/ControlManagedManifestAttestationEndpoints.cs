...
/// </summary>
public sealed class ControlManagedManifestAttestationEndpointModule : IHealingEndpointModule
{
    ...
    private static async Task<IResult> AttestAsync(
        ...
        Guid applicationId,
        Guid manifestId,
        ControlManagedManifestAttestationRequest request,
        HttpContext context,
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!result.Succeeded)
        {
            ...
            return Results.Problem(
                ...
                detail: "The persisted manifest does not match a Control-managed application revision and build identity.",
...
public sealed record ControlManagedManifestAttestationRequest(string? ManifestDigest, string? BuildId);
