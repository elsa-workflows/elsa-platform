...
public interface IControlHealingGitHubWebhookProcessor
{
...
public sealed class ControlHealingGitHubWebhookProcessor(
    HealingDbContext dbContext,
    GitHubWebhookProcessor processor,
    TimeProvider timeProvider,
    HealingAuditService? auditService = null) : IControlHealingGitHubWebhookProcessor
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (authority is null || observation.HeadReference != $"valence-control-healing/{authority.Attempt.Id:N}")
