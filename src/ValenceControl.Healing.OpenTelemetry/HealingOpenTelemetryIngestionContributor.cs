...
/// <summary>Authenticated claim names emitted by a Control-owned per-source OTLP authenticator.</summary>
public static class HealingTelemetryScopeClaims
{
    public const string WorkspaceId = "valence.control.workspace.id";
    public const string ApplicationId = "valence.control.application.id";
    public const string EnvironmentId = "valence.control.environment.id";
}
