    ...
    public WorkflowRuntimeCommandRetryDecision Decide(WorkflowRuntimeCommandClientStatus status, int retryAttempt)
    {
        ...
        return status switch
        {
            ...
            WorkflowRuntimeCommandClientStatus.RetryableError when retryAttempt < _options.MaxRetryAttempts =>
                new WorkflowRuntimeCommandRetryDecision(WorkflowRuntimeCommandRetryAction.Retry, DelayFor(retryAttempt), "Platform returned a retryable runtime command error."),
            ...
            WorkflowRuntimeCommandClientStatus.ValidationFailed =>
                new WorkflowRuntimeCommandRetryDecision(WorkflowRuntimeCommandRetryAction.StopWorker, TimeSpan.Zero, "Platform rejected the runtime command request."),
            _ =>
