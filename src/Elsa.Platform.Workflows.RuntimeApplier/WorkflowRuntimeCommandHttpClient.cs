    ...
    WorkflowArtifactRuntimeOptions options) : IWorkflowRuntimeCommandClient
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (response.StatusCode == HttpStatusCode.OK)
        {
            ...
            return body is null
                ? new WorkflowRuntimeCommandClaimResult(WorkflowRuntimeCommandClientStatus.RetryableError, "Platform claim response could not be read.")
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (response.StatusCode == HttpStatusCode.OK)
        {
            ...
            return body is null
                ? new WorkflowRuntimeCommandReportResult(WorkflowRuntimeCommandClientStatus.RetryableError, "Platform runtime command response could not be read.")
