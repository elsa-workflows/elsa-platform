...
{
    public const string DefaultSqliteConnectionString = "Data Source=valence-control-catalog.db";
    public const string SqliteMigrationsAssembly = "ValenceControl.PackageCatalog.Persistence.SqliteMigrations";
    public const string SqlServerMigrationsAssembly = "ValenceControl.PackageCatalog.Persistence.SqlServerMigrations";
