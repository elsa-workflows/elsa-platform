        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ObservedLifecycle = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    Health = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    DesiredStateRevisionId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ResolvedPlanId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ResolvedPlanSchemaVersion = table.Column<int>(type: "int", nullable: true),
                    ResolvedPlanContentHash = table.Column<string>(type: "nvarchar(71)", maxLength: 71, nullable: true),
                    ResolvedPlanUri = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                    CurrentReleaseDistributionId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    CurrentReleaseLine = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    CurrentReleaseVersion = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    CurrentReleaseManifestDigest = table.Column<string>(type: "nvarchar(71)", maxLength: 71, nullable: true),
                    CurrentReleaseComponentDigestsJson = table.Column<string>(type: "nvarchar(max)", maxLength: 65536, nullable: true),
                    CurrentDeploymentId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    CurrentDeploymentRevisionId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    CurrentDeploymentEndpointUri = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                    PlacementAssignmentId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ElsaTenantId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ElsaTenantAudience = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    LastOperationId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OperatorSubject = table.Column<string>(type: "nvarchar(71)", maxLength: 71, nullable: true),
                    OperationId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DeploymentRunId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    PriorState = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    NewState = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    DesiredStateRevisionId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    PlanReference = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                    DiagnosticCode = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    Summary = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    RequestKeyHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanonicalCallbackUri = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
                    VerifiedEndpointOrigin = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
                    BindingVersion = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceManifestDigest = table.Column<string>(type: "nvarchar(71)", maxLength: 71, nullable: true),
                    SourceDeploymentId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    TargetPlanId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    TargetPlanUri = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                    TargetReleaseLine = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    TargetVersion = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    TargetManifestDigest = table.Column<string>(type: "nvarchar(71)", maxLength: 71, nullable: true),
                    TargetDeploymentId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    Phase = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    SourceAccessMode = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    CutoverAt = table.Column<long>(type: "bigint", nullable: true),
                    SourceRetainUntil = table.Column<long>(type: "bigint", nullable: true),
                    EarlyReleaseApprovedByAccountId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    EarlyReleaseApprovedAt = table.Column<long>(type: "bigint", nullable: true),
                    SourceReleasedAt = table.Column<long>(type: "bigint", nullable: true),
                    CreatedAt = table.Column<long>(type: "bigint", nullable: false),
                    UpdatedAt = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedVersion = table.Column<int>(type: "int", nullable: false),
                    ...
                    FailureSummary = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    CreatedAt = table.Column<long>(type: "bigint", nullable: false),
                    UpdatedAt = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
