        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CatalogIdentityHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ...
                    ManifestReference = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
                    ManifestDigest = table.Column<string>(type: "nvarchar(71)", maxLength: 71, nullable: false),
                    PayloadDigest = table.Column<string>(type: "nvarchar(71)", maxLength: 71, nullable: false),
                    SignatureEvidenceReference = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
                    SignatureEvidenceDigest = table.Column<string>(type: "nvarchar(71)", maxLength: 71, nullable: false),
                    RegistryClass = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    DistributionId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Generation = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ReleaseLine = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ReleaseVersion = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Channel = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ProducerLifecycle = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Edition = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    SourceRepository = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
                    SourceCommit = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    SourceRunId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    CatalogLifecycle = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    AdmittedAtUtcTicks = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TopologyId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    PackageManifestSchema = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TopologyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TopologyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ComponentId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    CompanionComponentId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Digest = table.Column<string>(type: "nvarchar(71)", maxLength: 71, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TopologyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RuntimeKind = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiresTls = table.Column<bool>(type: "bit", nullable: false),
