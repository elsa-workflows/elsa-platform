        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArtifactJson = table.Column<string>(type: "TEXT", nullable: false),
                    ...
                    ObservedArtifactDigestAlgorithm = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    ObservedArtifactDigest = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    RuntimeReference = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true),
                    DiagnosticsJson = table.Column<string>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    UpdatedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    AvailableAt = table.Column<long>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    SafePayloadJson = table.Column<string>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<long>(type: "INTEGER", nullable: false),
