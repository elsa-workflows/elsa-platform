...
describe("AppShell", () => {
  ...
  it("renders the unified Valence Control navigation with package catalog active links", async () => {
    renderAppShell();
  ...
  it("toggles between light and dark mode", async () => {
    ...
    expect(window.localStorage.getItem("valence-control-console-theme")).toBe("dark");
  ...
  it("stores the selected accent theme", async () => {
    ...
    expect(window.localStorage.getItem("valence-control-console-theme-accent")).toBe("violet");
  });
...
function renderAppShell(
  ...
  vi.stubGlobal("fetch", vi.fn(async (input: RequestInfo | URL, init?: RequestInit) => {
    ...
    return Response.json({ name: "ValenceControl.Api", buildNumber });
  }));
...
function renderAppShellRoute(route: string) {
  ...
  vi.stubGlobal("fetch", vi.fn(async (input: RequestInfo | URL) => {
    ...
    return Response.json({ name: "ValenceControl.Api", buildNumber: "0.0.1" });
  }));
