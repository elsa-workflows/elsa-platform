...
describe("Healing overview and audit", () => {
  ...
  it("renders the accessible audit timeline and requests the next opaque page", async () => {
    ...
    expect(screen.getByText("Policy denied · Control service healing-worker")).toBeInTheDocument();
...
const auditFixture = {
  ...
  eventType: "merge-blocked", reasonCode: "policy-denied", actorType: "control-service", actorId: "healing-worker",
