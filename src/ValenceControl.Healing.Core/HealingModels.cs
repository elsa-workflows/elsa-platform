namespace ValenceControl.Healing.Core;
...
public enum DeploymentObservationSource { ControlDeployment, ExternalDelivery }
...
/// <summary>Immutable Control-generated patch proposal. Repository runners may validate it but cannot replace it.</summary>
...
/// <summary>
/// Durable, at-most-once admission for Control-managed inference. A lease may never be reacquired after its
...
public sealed class HumanCommand
{
    ...
    public string? ControlActorId { get; set; }
