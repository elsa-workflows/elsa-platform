...
public sealed class HealingOptions
{
    ...
    public bool ControlKillSwitch { get; set; }
...
public static class HealingGateReasonCodes
{
    ...
    public const string ControlKillSwitch = "control-kill-switch";
...
public sealed class HealingKillSwitch
{
    ...
    public HealingGateResult CanReviewIncidents() => EvaluateControlStage(_getOptions().IncidentReviewEnabled);

    public HealingGateResult CanVerify() => EvaluateControlStage(_getOptions().VerificationEnabled);
    ...
    private HealingGateResult EvaluateControlStage(bool enabled)
    {
        var options = _getOptions();
        if (options.ControlKillSwitch)
            return HealingGateResult.Block(HealingGateReasonCodes.ControlKillSwitch);
        return enabled
            ? HealingGateResult.Permit()
            : HealingGateResult.Block(HealingGateReasonCodes.StageDisabled);
    }
