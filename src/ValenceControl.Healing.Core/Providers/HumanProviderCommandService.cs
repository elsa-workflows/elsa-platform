...
public static class HumanProviderCommandPolicy
{
        ...
        HumanProviderCommandAuthorization authorization)
    {
        ...
        if (authorization.LinkedControlActorId is null)
            return Deny("control-identity-link-missing");
