...
public sealed class InMemoryDeploymentCockpitStore : IDeploymentCockpitStore, IWorkspaceDeploymentStore
{
    ...
    [
        ...
        Engine(
            ...
            "kv://acme-control/stage/elsa-api",
            DeploymentHealth.Degraded,
            CredentialVerificationStatus.Verified,
        ...
        Engine(
            ...
            "kv://acme-control/care-dev/elsa-api",
            DeploymentHealth.Healthy,
            CredentialVerificationStatus.Verified,
        ...
        Engine(
            ...
            "kv://acme-control/care-prod/elsa-api",
            DeploymentHealth.Healthy,
            CredentialVerificationStatus.Verified,
    ...
    [
        new(
            ...
            [
                ...
                Diff("secret-payment-api", DiffCategory.SecretReferences, "Payment API", "kv://acme-control/prod/payment-api:v3", "Missing reference", DiffImpact.Changed),
        ...
        new(
            ...
            [
                ...
                Diff("secret-payment-test", DiffCategory.SecretReferences, "Payment API", "kv://acme-control/test/payment-api:v3", "kv://acme-control/test/payment-api:v2", DiffImpact.Changed)
            ],
            [
