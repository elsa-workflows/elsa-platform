...
namespace Elsa.Platform.Healing.Persistence.SqliteMigrations.Migrations
{
    ...
    public partial class InitialHealing : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReasonCode = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    ActorType = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    ...
                    PolicyVersion = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    ...
                    SafeDetailJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceRevision = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    BuildId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    ManifestDigest = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    CanonicalJson = table.Column<string>(type: "TEXT", maxLength: 262144, nullable: false),
                    TrustState = table.Column<int>(type: "INTEGER", nullable: false),
                    VerifiedBy = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    VerifiedAt = table.Column<long>(type: "INTEGER", nullable: true),
                    VerificationMethod = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkspaceId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ApplicationId = table.Column<Guid>(type: "TEXT", nullable: false),
                    DiscoveryEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    RepairEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    AutomaticMergeEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    SignalProfileVersion = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    DefaultAttemptLimit = table.Column<int>(type: "INTEGER", nullable: false),
                    VerificationWindow = table.Column<TimeSpan>(type: "TEXT", nullable: false),
                    TimeBudget = table.Column<TimeSpan>(type: "TEXT", nullable: false),
                    ConcurrencyBudget = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Revision = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    DeployedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    Source = table.Column<int>(type: "INTEGER", nullable: false),
                    SourceIdempotencyKey = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    TrustIdentity = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PolicyVersion = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    PolicyHash = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    CreatedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    Version = table.Column<byte[]>(type: "BLOB", nullable: false),
                    PolicyKind = table.Column<int>(type: "INTEGER", nullable: false),
                    RequireReproduction = table.Column<bool>(type: "INTEGER", nullable: true),
                    AllowHighConfidenceInference = table.Column<bool>(type: "INTEGER", nullable: true),
                    MinimumInferenceConfidence = table.Column<decimal>(type: "TEXT", precision: 5, scale: 4, nullable: true),
                    MaximumTier = table.Column<int>(type: "INTEGER", nullable: true),
                    PermittedFieldsJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: true),
                    AutomaticMergeEnabled = table.Column<bool>(type: "INTEGER", nullable: true),
                    RequiredChecksJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: true),
                    IndependentVerifier = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    ForbiddenChangeCategoriesJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: true),
                    RequireRollbackOrStopCapability = table.Column<bool>(type: "INTEGER", nullable: true),
                    AllowedRootsJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: true),
                    ForbiddenRootsJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: true),
                    MaxFiles = table.Column<int>(type: "INTEGER", nullable: true),
                    MaxChangedLines = table.Column<int>(type: "INTEGER", nullable: true),
                    MaxPatchBytes = table.Column<int>(type: "INTEGER", nullable: true),
                    AllowBinary = table.Column<bool>(type: "INTEGER", nullable: true),
                    AllowRenames = table.Column<bool>(type: "INTEGER", nullable: true),
                    AllowSymlinks = table.Column<bool>(type: "INTEGER", nullable: true),
                    AllowSubmodules = table.Column<bool>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepositoryProviderId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    RepositoryOwner = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    RepositoryName = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    CredentialReference = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    WorkspaceId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ProviderDeliveryId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    InstallationId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    RepositoryProviderId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    Event = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    Action = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    BodyDigest = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    RetainedBody = table.Column<string>(type: "TEXT", maxLength: 262144, nullable: true),
                    ...
                    SafeOutcomeDetail = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: true),
                    Version = table.Column<byte[]>(type: "BLOB", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Source = table.Column<int>(type: "INTEGER", nullable: false),
                    ProfileVersion = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    OccurredAt = table.Column<long>(type: "INTEGER", nullable: false),
                    AcceptedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    RedactedEnvelopeJson = table.Column<string>(type: "TEXT", maxLength: 262144, nullable: false),
                    EnvelopeHash = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    WorkspaceId = table.Column<Guid>(type: "TEXT", nullable: false),
                    WorkspaceKillSwitch = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    UpdatedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    Version = table.Column<byte[]>(type: "BLOB", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PackageVersion = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    AssemblyName = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    ...
                    IsDirectDependency = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    HealingConfigurationId = table.Column<Guid>(type: "TEXT", nullable: false),
                    WorkspaceId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ApplicationId = table.Column<Guid>(type: "TEXT", nullable: false),
                    EnvironmentId = table.Column<Guid>(type: "TEXT", nullable: false),
                    DiscoveryEnabled = table.Column<bool>(type: "INTEGER", nullable: true),
                    RepairEnabled = table.Column<bool>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Name = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    SelectorKind = table.Column<int>(type: "INTEGER", nullable: false),
                    SelectorPattern = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: false),
                    ...
                    WorkflowIdentity = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: false),
                    WorkflowRevision = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    PathPolicyId = table.Column<Guid>(type: "TEXT", nullable: false),
                    EvidencePolicyId = table.Column<Guid>(type: "TEXT", nullable: false),
                    MergePolicyId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    ManifestId = table.Column<Guid>(type: "TEXT", nullable: false),
                    FromEntryId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ToEntryId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReasonCodesJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReleasedBundleId = table.Column<Guid>(type: "TEXT", nullable: true),
                    RequesterId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    RequestedTier = table.Column<int>(type: "INTEGER", nullable: false),
                    RequestedFieldsJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: false),
                    Purpose = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProvenanceJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: false),
                    OmissionsJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationId = table.Column<Guid>(type: "TEXT", nullable: false),
                    IncidentId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Command = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    ProviderActorId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    PlatformActorId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    ProviderPermissionSnapshotJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: false),
                    WorkspacePermissionGranted = table.Column<bool>(type: "INTEGER", nullable: false),
                    ConfirmationId = table.Column<Guid>(type: "TEXT", nullable: true),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    ResultCode = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    SafeResultDetail = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationId = table.Column<Guid>(type: "TEXT", nullable: false),
                    IncidentId = table.Column<Guid>(type: "TEXT", nullable: false),
                    PreviousEpisodeId = table.Column<Guid>(type: "TEXT", nullable: true),
                    OpenedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    ClosedAt = table.Column<long>(type: "INTEGER", nullable: true),
                    ProducingRevisionsJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: false),
                    TargetRevision = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    Outcome = table.Column<int>(type: "INTEGER", nullable: false),
                    RegressionReason = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: true),
                    Version = table.Column<byte[]>(type: "BLOB", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EpisodeId = table.Column<Guid>(type: "TEXT", nullable: false),
                    EnvironmentId = table.Column<Guid>(type: "TEXT", nullable: false),
                    RepairedRevision = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    WindowStartedAt = table.Column<long>(type: "INTEGER", nullable: true),
                    WindowEndsAt = table.Column<long>(type: "INTEGER", nullable: true),
                    RelevantOperationSuccessCount = table.Column<long>(type: "INTEGER", nullable: false),
                    LastRelevantOperationSuccessAt = table.Column<long>(type: "INTEGER", nullable: true),
                    RecurrenceCount = table.Column<long>(type: "INTEGER", nullable: false),
                    LastRecurrenceAt = table.Column<long>(type: "INTEGER", nullable: true),
                    Outcome = table.Column<int>(type: "INTEGER", nullable: false),
                    DeploymentObservationId = table.Column<Guid>(type: "TEXT", nullable: true),
                    SupportingOccurrenceId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FingerprintVersion = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    Fingerprint = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    RepairRepositoryKey = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    Severity = table.Column<int>(type: "INTEGER", nullable: false),
                    Classification = table.Column<int>(type: "INTEGER", nullable: false),
                    SelectedBindingId = table.Column<Guid>(type: "TEXT", nullable: true),
                    SelectedComponentEntryId = table.Column<Guid>(type: "TEXT", nullable: true),
                    FirstSeenAt = table.Column<long>(type: "INTEGER", nullable: false),
                    LastSeenAt = table.Column<long>(type: "INTEGER", nullable: false),
                    OccurrenceCount = table.Column<long>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProducingRevision = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    TargetRevision = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    EvidenceBundleId = table.Column<Guid>(type: "TEXT", nullable: false),
                    RepairClassification = table.Column<int>(type: "INTEGER", nullable: false),
                    NonceHash = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    LeaseOwner = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    LeaseToken = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    LeaseExpiresAt = table.Column<long>(type: "INTEGER", nullable: true),
                    BudgetJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: false),
                    UsageJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EpisodeId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ProviderConnectionId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ProviderWorkItemId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    Number = table.Column<long>(type: "INTEGER", nullable: true),
                    Url = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    MachineSummaryHash = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    ProviderState = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    ProjectionStatus = table.Column<int>(type: "INTEGER", nullable: false),
                    LastProjectedAt = table.Column<long>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PolicyVersion = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    PolicyHash = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    InputSnapshotHash = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    GateResultsJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaseExpiresAt = table.Column<long>(type: "INTEGER", nullable: true),
                    NextAttemptAt = table.Column<long>(type: "INTEGER", nullable: true),
                    ProviderCorrelationId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    OutcomeCode = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    SafeError = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: true),
                    CreatedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    UpdatedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    Version = table.Column<byte[]>(type: "BLOB", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkflowRunAttempt = table.Column<int>(type: "INTEGER", nullable: false),
                    BaseRevision = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    TargetRevision = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    Classification = table.Column<int>(type: "INTEGER", nullable: false),
                    Confidence = table.Column<decimal>(type: "TEXT", precision: 5, scale: 4, nullable: false),
                    UnifiedDiff = table.Column<string>(type: "TEXT", maxLength: 1048576, nullable: false),
                    PatchDigest = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    ChangedPathsJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: false),
                    ReproductionJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: false),
                    RegressionJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: false),
                    ValidationJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: false),
                    RiskJson = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepositoryOwner = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    RepositoryName = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    WorkflowReference = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: false),
                    WorkflowRevision = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    SourceReference = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: false),
                    SourceRevision = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    WorkflowRunId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    WorkflowRunAttempt = table.Column<int>(type: "INTEGER", nullable: false),
                    ActorId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    JwtId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    NonceHash = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    IssuedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    ExpiresAt = table.Column<long>(type: "INTEGER", nullable: false),
                    ExchangedAt = table.Column<long>(type: "INTEGER", nullable: true),
                    CapabilityTokenHash = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    Version = table.Column<byte[]>(type: "BLOB", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttemptId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ProviderConnectionId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ProviderPullRequestId = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    ...
                    BaseRevision = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    HeadRevision = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    PatchDigest = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    IsDraft = table.Column<bool>(type: "INTEGER", nullable: false),
                    Classification = table.Column<int>(type: "INTEGER", nullable: false),
                    CheckSnapshotJson = table.Column<string>(type: "TEXT", maxLength: 262144, nullable: false),
                    BranchProtectionSnapshotJson = table.Column<string>(type: "TEXT", maxLength: 262144, nullable: false),
                    MergePolicyEvaluationId = table.Column<Guid>(type: "TEXT", nullable: true),
                    MergeState = table.Column<int>(type: "INTEGER", nullable: false),
                    MergedRevision = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    MergedAt = table.Column<long>(type: "INTEGER", nullable: true),
                    ClosureReason = table.Column<string>(type: "TEXT", maxLength: 8192, nullable: true),
                    Version = table.Column<byte[]>(type: "BLOB", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.Sql(
                """
                CREATE TRIGGER "TR_HealingAuditEvents_BlockUpdate"
                BEFORE UPDATE ON "HealingAuditEvents"
                BEGIN
                    SELECT RAISE(ABORT, 'Healing audit events are append-only');
                END;
                """);
            migrationBuilder.Sql(
                """
                CREATE TRIGGER "TR_HealingAuditEvents_BlockDelete"
                BEFORE DELETE ON "HealingAuditEvents"
                BEGIN
                    SELECT RAISE(ABORT, 'Healing audit events are append-only');
                END;
                """);
        ...
        {
            migrationBuilder.Sql("DROP TRIGGER IF EXISTS \"TR_HealingAuditEvents_BlockUpdate\";");
            migrationBuilder.Sql("DROP TRIGGER IF EXISTS \"TR_HealingAuditEvents_BlockDelete\";");
