...
- **Layer:** Core — `ValenceControl.PackageCatalog.Core`
...
- **Known implementations:** `WorkspacePermissionOwnerProvisioner` *(cross-domain — ValenceControl.Api)* provisions the contributed workspace permission defaults.
