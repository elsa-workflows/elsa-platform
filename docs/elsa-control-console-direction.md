# Elsa Control Console Direction
...
Use Option A, Elsa Control Operations Console, as the primary shell and landing
...
The console should share Elsa Control's product identity but be denser and more
operational:
