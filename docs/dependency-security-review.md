...
Elsa Control uses `createBrowserRouter` in a client-rendered Vite
...
Exception owner: Elsa Control maintainers
...
dotnet list ElsaControl.sln package --vulnerable --include-transitive
```
