...
issuer="${ELSA_CONTROL_IDENTITY_ISSUER:-https://local.elsa-control.test}"
audience="${ELSA_CONTROL_IDENTITY_AUDIENCE:-elsa-control-dev}"
signing_key="${ELSA_CONTROL_IDENTITY_SIGNING_KEY:-local-development-control-identity-signing-key-change-me}"
ttl_seconds="${ELSA_CONTROL_IDENTITY_TOKEN_TTL_SECONDS:-3600}"
