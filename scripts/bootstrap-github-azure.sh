...
Configures the GitHub environment used by the Azure API Deploy workflow.
...
declare -A values=(
  ...
  [CATALOG_SQL_SQLSERVERFQDN]="$(azd_get CATALOG_SQL_SQLSERVERFQDN)"
  [ELSA_PACKAGE_CATALOG_AZURE_APP_SERVICE_DASHBOARD_URI]="$(azd_get ELSA_PACKAGE_CATALOG_AZURE_APP_SERVICE_DASHBOARD_URI)"
  [ELSA_PACKAGE_CATALOG_AZURE_CONTAINER_REGISTRY_ENDPOINT]="$(azd_get ELSA_PACKAGE_CATALOG_AZURE_CONTAINER_REGISTRY_ENDPOINT)"
  [ELSA_PACKAGE_CATALOG_AZURE_CONTAINER_REGISTRY_MANAGED_IDENTITY_CLIENT_ID]="$(azd_get ELSA_PACKAGE_CATALOG_AZURE_CONTAINER_REGISTRY_MANAGED_IDENTITY_CLIENT_ID)"
  [ELSA_PACKAGE_CATALOG_AZURE_CONTAINER_REGISTRY_MANAGED_IDENTITY_ID]="$(azd_get ELSA_PACKAGE_CATALOG_AZURE_CONTAINER_REGISTRY_MANAGED_IDENTITY_ID)"
  [ELSA_PACKAGE_CATALOG_AZURE_WEBSITE_CONTRIBUTOR_MANAGED_IDENTITY_ID]="$(azd_get ELSA_PACKAGE_CATALOG_AZURE_WEBSITE_CONTRIBUTOR_MANAGED_IDENTITY_ID)"
  [ELSA_PACKAGE_CATALOG_AZURE_WEBSITE_CONTRIBUTOR_MANAGED_IDENTITY_PRINCIPAL_ID]="$(azd_get ELSA_PACKAGE_CATALOG_AZURE_WEBSITE_CONTRIBUTOR_MANAGED_IDENTITY_PRINCIPAL_ID)"
  [ELSA_PACKAGE_CATALOG_PLANID]="$(azd_get ELSA_PACKAGE_CATALOG_PLANID)"
)
