# Valence Control homepage design review
...
- The Studio → Valence Control → Runtime boundary is explained accurately.
...
**Recommendation:** update canonical, Open Graph, schema.org, and social metadata to the official Valence Control domain and accounts before promoting the page.
